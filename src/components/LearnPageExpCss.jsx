...
import '../assets/css/LearnPageExpCss.css'

function LearnPageExpCss() {
    ...
    return (
        <>
            <section id='LearnPageExpCss'>
                <div className='LearnPageExpCss-bk-big'>
                    <div className='LearnPageExpCss-content-1'>
                        <p>目前獲得的能力:</p>
                    </div>
...
export default LearnPageExpCss
