...
function Home() {
    ...
    const useScrollEffect = (ref, className) => {
        useEffect(() => {
            const handleScroll = () => {
                if (ref.current) {
    ...
    useScrollEffect(blueARef, 'active');
    useScrollEffect(redRef, 'active');
    useScrollEffect(pinkRef, 'active');
                ...
                <div id="Home-page-all">
                    <section id="Home-page-2">
                        <div className="Home-content-bk-1">
                            <div className="Home-content-1" data-aos="fade-right" data-aos-duration="500" data-aos-offset="300">
                                <p className="Home-text-1">用<span>程式</span>創造未來</p>
                                <p className="Home-eng-text-1">Create the Future with Programming</p>
                            </div>
                            <div className="Home-content-2" data-aos="fade-right" data-aos-duration="500" data-aos-offset="300">
                        ...
                        <div className="Home-content-bk-2">
                            <div className="Home-content-3">
                                <div className="Home-text-block-1" data-aos="fade-right" data-aos-duration="500" data-aos-offset="300">
                                    <p className="Home-text-2">程式語言納入108課綱</p>
                                    <br />
                                    <p className="Home-eng-text-2">Programming included in 108 syllabus</p>
                                    <p className="Home-sml-text-2">
                                        為了因應科技時代的需求，<br />
                            ...
                            <div className="Home-content-4">
                                <div className="Home-text-block-2" data-aos="fade-left" data-aos-duration="500" data-aos-offset="300">
                                    <p className="Home-text-2">2030雙語政策</p>
                                    <br />
                                    <p className="Home-eng-text-2">Bilingual 2030</p>
                                    <p className="Home-sml-text-2">
                                        教育部正在推動「2030雙語政策」。<br />
                                        目標是到2030年在國民教育中達成雙語環境，<br />
                                        希望孩子不僅能在課堂上學習語法與詞彙，<br />
                                        更能在日常生活和學習中靈活運用英語，<br />
                                        讓孩子未來更具國際競爭力！
                                    </p>
                                </div>
                    ...
                    {/* Additional Sections (Home-page-3, Home-page-4, etc.) */}

                    <section id="Home-page-5">
                        <div className="Home-content-bk-4" data-aos="zoom-in" data-aos-duration="500" data-aos-offset="300">
                            <div className="Home-content-15">
                                <p className="Home-content-13">還在猶豫什麼？<br /> 程式世界等著你去探索 ！</p>
                            </div>
